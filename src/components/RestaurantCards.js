...
const RestaurantCards = ({ resData }) => {
  ...
  return (
    <div className="m-1 p-1 w-[208px] h-[350px] rounded-lg bg-gray-150 border-[1px] hover:bg-gray-300 "  >
...
export const WithVegLable=()=>{
  return (props)=>{
    return (
      <div>
        <label className="absolute bg-green-400 px-3 rounded-lg m-1 mx-2 ">Vegetarian</label>
...
export const WithNonVegLable=()=>{
  return (props)=>(
    <div>
      <label className="absolute bg-red-700 rounded-lg px-3 m-1 mx-2 text-white">Non-veg.</label>
      <RestaurantCards{...props}/>
    </div>
  )
}
